...
class ULabel {
    ...
    */
    ...
    static create_listeners(ul) {
        ...
        jquery_default()(document).on("input", "input.frame_input", (e) => {
            ul.change_frame();
        });
    ...
    show_annotation_mode(el=null) {
        ...
        if (["whole-image", "global"].includes(this.subtasks[this.state["current_subtask"]]["state"]["annotation_mode"])) {
            jquery_default()("div.frame_annotation_dialog").addClass("active");
        }
        else {
    ...
    change_frame(delta=null) {
        let new_frame = parseInt(jquery_default()(`div#${this.config["toolbox_id"]} input.frame_input`).val());
        if (delta != null) {
