    ...
    */
    ...
    set_subtask(st_key) {
        ...
        if (this.state["current_subtask"]) {
            jquery_default()("div#canvasses__" + this.state["current_subtask"]).css("z-index", -1);
        }
    ...
    show_id_dialog(gbx, gby, active_ann, thumbnail=false) {
        ...
        let idd = jquery_default()("#" + this.config["id"]);
        ...
        if (thumbnail) {
            ...
            jquery_default()("#" + this.config["id"] + ".thumb").css({
    ...
    hide_id_dialog() {
        ...
        jquery_default()("#" + this.config["id"]).css("display", "none");
    }
