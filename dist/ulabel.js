...
class ULabel {
    ...
    static add_style_to_document(ul) {
        ...
        head.appendChild(style);
        if (style.styleSheet) {
            style.styleSheet.cssText = (0,_blobs__WEBPACK_IMPORTED_MODULE_9__.get_init_style)(ul.config["container_id"]);
        }
        else {
            style.appendChild(document.createTextNode((0,_blobs__WEBPACK_IMPORTED_MODULE_9__.get_init_style)(ul.config["container_id"])));
        }
    }
